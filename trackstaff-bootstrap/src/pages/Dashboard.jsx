                ...
                <div className="d-flex align-items-center justify-content-between">
                  <div className="d-flex flex-column gap-3">
                    ...
                    <p className="text-danger m-0" style={{ fontSize: "15px" }}>
                      <i className="bi bi-exclamation-circle"></i> 3 employees
                      absent today
                    </p>
                    <p className="text-danger m-0" style={{ fontSize: "15px" }}>
                    ...
                    <p className="text-danger m-0" style={{ fontSize: "15px" }}>
                      <i className="bi bi-exclamation-circle"></i> 2 projects
                      approval pending
                    </p>
                    <p className="text-danger m-0" style={{ fontSize: "15px" }}>
              ...
              <div className="card-body p-2 d-flex align-items-center gap-2">
                ...
                <div className="flex-fill">
                  <div className="d-flex justify-content-between gap-2">
                    <p className="mb-0 fw-medium " style={{ fontSize: "18px" }}>
                      Nirmal GC
                    </p>
              ...
              <ul className="d-flex flex-column gap-4 p-0 z-1 mt-1">
                <li className="d-flex gap-3 list-unstyledm-0">
                  ...
                  <div className="d-flex flex-column">
                    <p className="mb-1 fw-medium" style={{ fontSize: "18px" }}>
                      Cheap Flights Nepal
                    </p>
                    <p className="mb-1 text-muted" style={{ fontSize: "16px" }}>
                      Home Page
                    </p>
                    <p className="mb-1 text-muted" style={{ fontSize: "16px" }}>
                      Landing Page
