            ...
            >
              ...
              >
                <div className="chat-container p-3">
                  {/* Header */}
                  <div className="d-flex justify-content-between align-items-baseline mb-3 bg-light flex-wrap">
            ...
            <div className="rounded-3 bg-white p-4 d-flex flex-column gap-4">
              ...
              <div className="d-flex flex-column gap-3">
                <div className="d-flex justify-content-between align-items-center">
                  <h5 className="fw-semibold mb-0">Your Task Status</h5>
                  <a
                    href="#"
              ...
              <div className="d-flex flex-column gap-3">
                <div className="d-flex justify-content-between align-items-center">
                  <h5 className="fw-semibold mb-0">Assigned by</h5>
                  <a
                    href="#"
                    className="fw-medium text-decoration-none"
                    style={{ color: "#1a6a99" }}
